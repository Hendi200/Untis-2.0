...
// TEXT COLORS DARKENED TO 950 FOR BETTER READABILITY IN LIGHT MODE
export const AVAILABLE_SUBJECTS: SubjectOption[] = [
  { id: 'blue', name: 'Englisch', short: 'E', room: '', teacher: '', 
    color: 'border-l-blue-600 bg-blue-50 dark:bg-blue-600/10', modalColor: 'bg-blue-600', textColor: 'text-blue-950 dark:text-blue-200', borderColor: 'border-blue-200 dark:border-blue-800' },
  
  { id: 'rose', name: 'Musik', short: 'MU', room: '', teacher: '', 
    color: 'border-l-rose-500 bg-rose-50 dark:bg-rose-500/10', modalColor: 'bg-rose-500', textColor: 'text-rose-950 dark:text-rose-200', borderColor: 'border-rose-200 dark:border-rose-800' },
  
  { id: 'slate', name: 'Kunst', short: 'KU', room: '', teacher: '', 
    color: 'border-l-slate-600 bg-slate-100 dark:bg-slate-600/10', modalColor: 'bg-slate-700', textColor: 'text-slate-950 dark:text-slate-200', borderColor: 'border-slate-400 dark:border-slate-600' },
  
  { id: 'sky', name: 'Sport', short: 'SP', room: '', teacher: '', 
    color: 'border-l-sky-500 bg-sky-50 dark:bg-sky-500/10', modalColor: 'bg-sky-500', textColor: 'text-sky-950 dark:text-sky-200', borderColor: 'border-sky-200 dark:border-sky-800' },
  
  { id: 'orange', name: 'Informatik', short: 'IF', room: '', teacher: '', 
    color: 'border-l-orange-500 bg-orange-50 dark:bg-orange-500/10', modalColor: 'bg-orange-500', textColor: 'text-orange-950 dark:text-orange-200', borderColor: 'border-orange-200 dark:border-orange-800' },
  
  { id: 'teal', name: 'Geschichte', short: 'GE', room: '', teacher: '', 
    color: 'border-l-teal-800 bg-teal-50 dark:bg-teal-800/10', modalColor: 'bg-teal-800', textColor: 'text-teal-950 dark:text-teal-200', borderColor: 'border-teal-200 dark:border-teal-800' },
  
  { id: 'green', name: 'Erdkunde', short: 'EK', room: '', teacher: '', 
    color: 'border-l-green-700 bg-green-50 dark:bg-green-700/10', modalColor: 'bg-green-700', textColor: 'text-green-950 dark:text-green-200', borderColor: 'border-green-200 dark:border-green-800' },
  
  { id: 'indigo', name: 'Chemie', short: 'CH', room: '', teacher: '', 
    color: 'border-l-indigo-700 bg-indigo-50 dark:bg-indigo-700/10', modalColor: 'bg-indigo-700', textColor: 'text-indigo-950 dark:text-indigo-200', borderColor: 'border-indigo-200 dark:border-indigo-800' },
  
  { id: 'red', name: 'Deutsch', short: 'D', room: '', teacher: '', 
    color: 'border-l-red-600 bg-red-50 dark:bg-red-500/10', modalColor: 'bg-red-600', textColor: 'text-red-950 dark:text-red-200', borderColor: 'border-red-200 dark:border-red-800' },
  
  { id: 'yellow', name: 'Mathe', short: 'M', room: '', teacher: '', 
    color: 'border-l-yellow-400 bg-yellow-50 dark:bg-yellow-500/10', modalColor: 'bg-yellow-400', textColor: 'text-yellow-950 dark:text-yellow-200', borderColor: 'border-yellow-200 dark:border-yellow-800' },
  
  { id: 'purple', name: 'Katholische Religion', short: 'KR', room: '', teacher: '', 
    color: 'border-l-purple-500 bg-purple-50 dark:bg-purple-500/10', modalColor: 'bg-purple-500', textColor: 'text-purple-950 dark:text-purple-200', borderColor: 'border-purple-200 dark:border-purple-800' },

  { id: 'nl', name: 'Niederländisch', short: 'NL', room: '', teacher: '', 
    color: 'border-l-orange-500 bg-orange-50 dark:bg-orange-500/10', modalColor: 'bg-orange-500', textColor: 'text-orange-950 dark:text-orange-200', borderColor: 'border-orange-200 dark:border-orange-800' },

  { id: 'violet', name: 'Mathe Vertiefung', short: 'MVX1', room: '', teacher: '', 
    color: 'border-l-slate-400 bg-white dark:bg-slate-100/5', modalColor: 'bg-slate-500', textColor: 'text-slate-950 dark:text-slate-200', borderColor: 'border-slate-300 dark:border-slate-700' },

  { id: 'emerald', name: 'Biologie', short: 'BI', room: '', teacher: '', 
    color: 'border-l-emerald-600 bg-emerald-50 dark:bg-emerald-500/10', modalColor: 'bg-emerald-600', textColor: 'text-emerald-950 dark:text-emerald-200', borderColor: 'border-emerald-200 dark:border-emerald-800' },

  { id: 'fuchsia', name: 'Philosophie', short: 'PL', room: '', teacher: '', 
    color: 'border-l-fuchsia-600 bg-fuchsia-50 dark:bg-fuchsia-500/10', modalColor: 'bg-fuchsia-600', textColor: 'text-fuchsia-950 dark:text-fuchsia-200', borderColor: 'border-fuchsia-200 dark:border-fuchsia-800' },

  { id: 'cyan', name: 'Pädagogik', short: 'PA', room: '', teacher: '', 
    color: 'border-l-cyan-600 bg-cyan-50 dark:bg-cyan-500/10', modalColor: 'bg-cyan-600', textColor: 'text-cyan-950 dark:text-cyan-200', borderColor: 'border-cyan-200 dark:border-cyan-800' },

  { id: 'sw', name: 'SoWi', short: 'SW', room: '', teacher: '', 
    color: 'border-l-pink-500 bg-pink-50 dark:bg-pink-500/10', modalColor: 'bg-pink-500', textColor: 'text-pink-950 dark:text-pink-200', borderColor: 'border-pink-200 dark:border-pink-800' },
  
  { id: 'spa', name: 'Spanisch', short: 'S', room: '', teacher: '', 
    color: 'border-l-lime-500 bg-lime-50 dark:bg-lime-500/10', modalColor: 'bg-lime-500', textColor: 'text-lime-950 dark:text-lime-200', borderColor: 'border-lime-200 dark:border-lime-800' },
  
  { id: 'fr', name: 'Französisch', short: 'F', room: '', teacher: '', 
    color: 'border-l-violet-600 bg-violet-50 dark:bg-violet-600/10', modalColor: 'bg-violet-600', textColor: 'text-violet-950 dark:text-violet-200', borderColor: 'border-violet-200 dark:border-violet-800' },
  
  { id: 'ph', name: 'Physik', short: 'PH', room: '', teacher: '', 
    color: 'border-l-sky-700 bg-sky-50 dark:bg-sky-700/10', modalColor: 'bg-sky-700', textColor: 'text-sky-950 dark:text-sky-200', borderColor: 'border-sky-200 dark:border-sky-800' },

  { id: 'er', name: 'Ev. Religion', short: 'ER', room: '', teacher: '', 
    color: 'border-l-purple-400 bg-purple-50 dark:bg-purple-400/10', modalColor: 'bg-purple-400', textColor: 'text-purple-950 dark:text-purple-200', borderColor: 'border-purple-200 dark:border-purple-800' },

  { id: 'lat', name: 'Latein', short: 'L', room: '', teacher: '', 
    color: 'border-l-stone-500 bg-stone-50 dark:bg-stone-500/10', modalColor: 'bg-stone-500', textColor: 'text-stone-950 dark:text-stone-200', borderColor: 'border-stone-200 dark:border-stone-800' },

  { id: 'lit', name: 'Literatur', short: 'LI', room: '', teacher: '', 
    color: 'border-l-amber-500 bg-amber-50 dark:bg-amber-500/10', modalColor: 'bg-amber-500', textColor: 'text-amber-950 dark:text-amber-200', borderColor: 'border-amber-200 dark:border-amber-800' },
];
